...
def run_games(special_prob_dist,  top_configurations, plays_per_comb):
    ...
    for animal_prob_dist in top_configurations:
        ...
        data.append([animal_prob_dist[0], animal_prob_dist[1], animal_prob_dist[2], animal_prob_dist[3], res[b_value], res[r_value], res[d_value], special_prob_dist[1]/sum(special_prob_dist)])
        idx += 1
